...
public class DataSources {
	...
	private static final String BD_BDC_PASSWORD = "";
	private static final String BD_SGR_USER = "sgr_reclamos";
	private static final String BD_SGR_PASSWORD = "";
	private static final String BD_PTE_USER = "pte_subtel";
	private static final String BD_PTE_PASSWORD = "";
	private static final String BD_GABINETE_USER = "gabinete";
	private static final String BD_GABINETE_PASSWORD = "";
	private static final String BD_ARCGIS_USER = "arcgis";
	private static final String BD_ARCGIS_PASSWORD = "";
